<template>
  <fieldset class="agenda-item-form">
    ...
    <ui-form-group
      v-for="[name, field] in Object.entries($options.agendaItemFormSchemas[localAgendaItem.type])"
      :key="name"
      :label="field.label"
    >
      <component :is="field.component" v-model="localAgendaItem[name]" v-bind="field.props" />
    </ui-form-group>
  </fieldset>
</template>
